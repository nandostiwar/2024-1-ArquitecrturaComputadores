    ...
    return (
        <div className="container">
            ...
            <form>
                ...
                <input type="submit" className="btnEnviar" value="elevar_al_cuadrado" onClick={handleSubmit}/>
                <input type="submit" className="btnEnviar" value="raizCuadrada" onClick={handleSubmit}/>
            </form>
